...
// This will not re-render if the exact same searchField entry is entered, it knows to only do so if searchField changes
const App = () => {
	...
	return (
		<div className="App">
			<h1 className="app-title">Monstar's Rolodex</h1>
			<SearchBox
